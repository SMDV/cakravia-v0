        ...
        <div className="px-6 py-6">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600 text-sm leading-relaxed">
              You now have access to your complete Behavioral Assessment results and can download your official certificate.
            </p>
          </div>
...
const EnhancedBehavioralResultsDashboard = () => {
  ...
  const loadResults = useCallback(async () => {
    ...
    try {
      ...
      const results = await behavioralAPI.getTestResults('latest');
